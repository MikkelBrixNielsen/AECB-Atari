...
# ChatGPT used as sparring partner for model architecture of encoder / decoder
...
class VectorQuantizer(nn.Module): # Based on "van den Oord et al., 2017" - https://arxiv.org/pdf/1711.00937
